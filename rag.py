...
"""
    ...
    def generate_welcome_message(self) -> str:
        """
        Генерирует приветственное сообщение на основе системного промпта.
...
На основе этой роли и правил, создай краткое приветственное сообщение для команды /start в Telegram боте.

Требования к сообщению:
1. Краткое приветствие (1-2 предложения)
2. Описание роли бота
3. Список доступных команд (/help, /stats, /logs)
4. Призыв задать вопрос

Сообщение должно быть на русском языке, дружелюбным и профессиональным.
...
💬 Просто напишите ваш вопрос!"""
    ...
    def generate_help_message(self) -> str:
        """
        Генерирует справку на основе системного промпта.
        
        Returns:
            Сообщение справки для команды /help
        """
        help_prompt = f"""{self.system_prompt}

На основе этой роли и правил, создай подробную справку для команды /help in Telegram боте.

Требования к справке:
1. Описание того, как работает бот
2. Список доступных команд с описанием
3. Примеры вопросов, которые можно задать (5-7 примеров)

Справка должна быть на русском языке, структурированной и информативной.
Используй эмодзи для улучшения читаемости.
